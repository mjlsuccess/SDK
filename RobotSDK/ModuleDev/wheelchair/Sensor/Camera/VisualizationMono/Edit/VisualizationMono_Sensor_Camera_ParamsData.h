...
/*! \def VisualizationMono_Sensor_Camera_INPUTPORTSSIZE
	...
	\details
	- Input Port #0: Buffer_Size = 1, Params_Type = SensorInternalEvent_Sensor_Camera_Params, Data_Type = SensorInternalEvent_Sensor_Camera_Data
*/
#define VisualizationMono_Sensor_Camera_INPUTPORTSSIZE QList<int>()<<1
